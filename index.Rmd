...
moments=c("Buildup","Bass Block", "Bass Block + High Heads", "Piano", "Bass Block + High Heads", "Piano", "Outro")
...
SSM_Chroma + theme(axis.text.x= element_text(face="plain" ,angle=45))
...
Listen to the file to find out!

![Brainstorm Special Request](Brainstorm Special Request.mp3)
...
ggplot(discover_weekly4, aes(energy, danceability, col=instrumentalness, size=tempo))+
  geom_point()+
  labs(title='Discover Weekly 4',                       
    x = "Energy",
    y = "Danceability",
    colour = "Instrumentalness",
    size="Tempo")  + 
